...
class TrainVQGAN:
    ...
    def train(self, args):
        ...
        print('Começando o treino do VQ-GAN') 
        for epoch in range(args.epochs):
            with tqdm(range(len(train_dataset))) as pbar:
                for i, imgs in zip(pbar, train_dataset):
                    ...
                    A = self.vqgan.calculate_lambda(perceptual_rec_loss, g_loss)

                    vq_loss = perceptual_rec_loss + q_loss + disc_factor*A*g_loss
                    ...
                    if i % 10 == 0:
                        with torch.no_grad():
                            ...
                            vutils.save_image(real_fake_images, os.path.join('results_vqgan', f'{epoch}_{i}.jpg'), nrow=4)
